...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    if(!isset($_SESSION['username'])){
        ...
        echo "<a class='nav-link' href='profile.php'>".$_SESSION['username']."</a><a class='nav-link' href='logout.php'>Log out</a>";
    }
    ?>
  </div>
  </div>
    ...
    <div class = "container">
        <div class = "col-lg-12">
            <br>
            <h1 class = "text-dark text-center"> Timeline</h1>
            <br>
...
?>
            ...
            <div class="justify-content-center">
                <div class="card">
                    <div class=" p-3 ">
                        <h3 class="mb-0 mt-2 font-italic"><?php echo $res['message']; ?></h3>
